        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 pt-12 border-t border-white/10">
          ...
          <div className="md:col-span-2 space-y-6">
            <Link href="/" className="flex items-center gap-2">
              <div className="w-12 h-12 rounded-full bg-[#C85A32] hover:bg-[#B24F2A] bg-primary flex items-center justify-center text-primary-foreground font-serif font-bold text-2xl italic">
                S
              </div>
